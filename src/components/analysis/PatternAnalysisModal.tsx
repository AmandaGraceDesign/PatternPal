                    ...
                    <>
                      <div className="flex items-center gap-2 flex-wrap">
                        {effectiveAnalysis.chromaticColors.map((color, i) => (
                          ...
                          >
                            <div
                              className={`w-9 h-9 [@media(hover:hover)]:w-8 [@media(hover:hover)]:h-8 rounded-full ${
                                color.isClashing
                            ...
                            <button
                              ...
                              className="absolute -top-1.5 -right-1.5 w-5 h-5 [@media(hover:hover)]:w-4 [@media(hover:hover)]:h-4 rounded-full bg-red-500 text-white flex items-center justify-center opacity-100 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100 transition-opacity"
