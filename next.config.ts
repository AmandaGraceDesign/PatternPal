...
const nextConfig: NextConfig = {
  async headers() {
    ...
    const csp = [
      ...
      "img-src 'self' data: blob: https://img.clerk.com https://www.googletagmanager.com https://www.google.com https://consent.cookiebot.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://ct.pinterest.com",
      "font-src 'self' data: https://fonts.gstatic.com https://r2cdn.perplexity.ai",
      "connect-src 'self' https://*.clerk.com https://*.clerk.dev https://*.accounts.dev https://clerk.amandagracedesign.com https://api.stripe.com https://r.stripe.com https://r.wdfl.co https://*.rewardful.com https://*.getrewardful.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://buphppye.usa.stape.io https://consent.cookiebot.com https://consentcdn.cookiebot.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://pagead2.googlesyndication.com https://ct.pinterest.com",
